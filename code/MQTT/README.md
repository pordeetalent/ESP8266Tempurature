...
- ติดตั้ง ESP8266WiFi.h </br> เวอร์ชั่น 1.0.0
- ติดตั้ง PubSubClient.h </br> เวอร์ชั่น 2.7.0
- ติดตั้ง DHT.h </br> เวอร์ชั่น 1.4.2
- ติดตั้ง TridentTD_LineNotify.h </br> เวอร์ชั่น 3.0.2
